...
setInterval(()=>{
    let date = new Date();
console.log(`the current time is ${date.getHours()}hrs:${date.getMinutes()}min:${date.getSeconds()}sec`);
let time = document.getElementById("time");
time.innerText = `${date.getHours()}hrs:${date.getMinutes()}min:${date.getSeconds()}sec`;
time.style.fontSize = "4rem ";
...
console.log(`the current time is ${date.getHours()}hrs:${date.getMinutes()}min:${date.getSeconds()}sec`);
let time = document.getElementById("time");
time.innerHTML = `${date.getHours()}hrs:${date.getMinutes()}min:${date.getSeconds()}sec`;
*/
